...
export interface int64_property_type extends non_typed_property_type {
    size?: number;
    index?: number;
    padding?: number;
    value?: number;
}
export const int64_property_data: int64_property_type = {
    size: 1,
    index: 1,
    padding: 0,
    value: 2,

    parseProperty: function (readStream: Buffer, offset: number, int64_property_type: string, parent_property_type: string) {
        let propertyData: int64_property_type = {}
